...
<div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
    ...
    <a href="{{ route('guru.absensi.recap-export', $kelas->id) }}" class="inline-flex items-center px-3 py-1.5 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700 transition-colors">
