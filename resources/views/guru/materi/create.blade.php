...
<div class="mb-6">
    <a href="{{ isset($kelas_id) ? route('guru.kelas.show', $kelas_id) : route('guru.materi.index') }}" class="inline-flex items-center text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 mb-3 transition-colors">
