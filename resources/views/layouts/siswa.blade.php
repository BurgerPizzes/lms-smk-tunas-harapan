...
@section('content')
    ...
    <aside id="sidebar" class="sidebar-transition fixed top-16 left-0 h-[calc(100vh-4rem)] w-64 bg-emerald-600 text-white z-40 flex flex-col -translate-x-full lg:translate-x-0 overflow-y-auto">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1">
            ...
            {{-- Materi --}}
            <a href="{{ route('siswa.kelas.index') }}" class="nav-item flex items-center px-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('siswa.materi.*') ? 'bg-emerald-700 text-white shadow-lg shadow-emerald-800/30' : 'text-emerald-50 hover:bg-emerald-700 hover:text-white' }}">
                <svg class="w-5 h-5 mr-3 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            {{-- Tugas --}}
            <a href="{{ route('siswa.submissions.index') }}" class="nav-item flex items-center px-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('siswa.tugas.*', 'siswa.submissions.*') ? 'bg-emerald-700 text-white shadow-lg shadow-emerald-800/30' : 'text-emerald-50 hover:bg-emerald-700 hover:text-white' }}">
                <svg class="w-5 h-5 mr-3 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            {{-- Quiz --}}
            <a href="{{ route('siswa.kelas.index') }}" class="nav-item flex items-center px-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('siswa.quiz.*') ? 'bg-emerald-700 text-white shadow-lg shadow-emerald-800/30' : 'text-emerald-50 hover:bg-emerald-700 hover:text-white' }}">
                <svg class="w-5 h-5 mr-3 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
