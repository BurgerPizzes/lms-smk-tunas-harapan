                        ...
                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                            ...
                            <div class="flex items-center gap-3 flex-shrink-0">
                                @if($status === 'tersedia' && (!$attempt || $attempt->can_retry ?? false))
                                    <a href="{{ route('siswa.quiz.take', $quiz) }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-sm font-medium shadow-sm">
