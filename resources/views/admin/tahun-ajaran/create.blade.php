...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Tahun Ajaran Baru</h1>
</div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
        <form method="POST" action="{{ route('admin.tahun-ajaran.store') }}">
            ...
            <div class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" id="tahun_selesai" name="tahun_selesai" value="{{ old('tahun_selesai') }}" required min="2000" max="2100" class="w-full px-4 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-colors" placeholder="2025">
                ...
                <div>
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" name="is_active" value="1" {{ !old('is_active', '0') == '0' ? 'checked' : '' }} class="sr-only peer">
                    ...
                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-1 ml-14">Mengaktifkan tahun ajaran ini akan menonaktifkan tahun ajaran lainnya.</p>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end space-x-3 pt-6 mt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <button type="submit" class="px-5 py-2.5 text-sm font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition-colors shadow-sm">Simpan Tahun Ajaran</button>
            </div>
        </form>
    </div>
</div>
