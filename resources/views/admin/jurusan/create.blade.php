...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Jurusan Baru</h1>
</div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
        <form method="POST" action="{{ route('admin.jurusan.store') }}">
            ...
            <div class="flex items-center justify-end space-x-3 pt-6 mt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <button type="submit" class="px-5 py-2.5 text-sm font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition-colors shadow-sm">Simpan Jurusan</button>
            </div>
        </form>
    </div>
</div>
