...
<div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5 mb-6">
    ...
    <form method="POST" action="{{ route('admin.kelas.members.store', $kelas->id) }}" class="flex flex-col sm:flex-row gap-3">
        @csrf
        <div class="flex-1">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 member-row">
                    ...
                    <td class="px-5 py-4 text-center">
                        <form method="POST" action="{{ route('admin.kelas.members.remove', [$kelas->id, $member->id]) }}" class="inline" onsubmit="return confirm('Yakin ingin menghapus {{ $member->name }} dari kelas ini?')">
                            @csrf @method('DELETE')
